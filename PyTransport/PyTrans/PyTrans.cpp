...
#include"/home/gsalinas/GitHub/orbital/PyTransport/CppTrans/NC/evolve.h"//evolve
#include"/home/gsalinas/GitHub/orbital/PyTransport/CppTrans/NC/moments.h"//moments
#include"/home/gsalinas/GitHub/orbital/PyTransport/CppTrans/NC/model.h"//model
#include"/home/gsalinas/GitHub/orbital/PyTransport/CppTrans/stepper/rkf45.hpp"//stepper
//************************************************************************************************* 
...
// Package recompile attempted at: Fri Mar 17 15:11:14 2023
...
// **************************************************************************************    
static struct PyModuleDef PyTransModule = {PyModuleDef_HEAD_INIT, "PyTransOrbital", PyTrans_docs, -1, PyTransOrbital_methods}; //modDef
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
    
// **************************************************************************************
PyMODINIT_FUNC PyInit_PyTransOrbital(void)    {    PyObject *m = PyModule_Create(&PyTransModule); import_array(); return m;} //initFunc
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
